...
export const ROUTE_MAP = {
    ...
    "/services": { appId: "aboutMe", index: 2 },
    "/ai-workflow": { appId: "aboutMe", index: 3 },
    "/skills": { appId: "aboutMe", index: 4 },
    "/projects": { appId: "aboutMe", index: 5 },
    "/education": { appId: "aboutMe", index: 6 },
    "/resume": { appId: "aboutMe", index: 7 },
    "/contact": { appId: "aboutMe", index: 8 },
